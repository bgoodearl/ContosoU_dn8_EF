...
namespace CU.Infrastructure.Migrations
{
    ...
    [Migration("20231208153219_CU6_M05_AddLookups2")]
    partial class CU6_M05_AddLookups2
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("ContosoUniversity.Models.OfficeAssignment", b =>
                {
                    ...
                    b.Property<short?>("OBLTId")
                        .HasColumnType("smallint");

                    b.Property<string>("OfficeBuildingCode")
                        .HasColumnType("nvarchar(2)");

                    b.HasKey("InstructorID");

                    b.HasIndex("OBLTId", "OfficeBuildingCode");
            ...
            modelBuilder.Entity("ContosoUniversity.Models.Lookups.OfficeBuilding", b =>
                {
                    b.HasBaseType("ContosoUniversity.Models.Lookups.LookupBaseWith2cKey");
            ...
            modelBuilder.Entity("ContosoUniversity.Models.OfficeAssignment", b =>
                {
                    ...
                    b.HasOne("ContosoUniversity.Models.Lookups.OfficeBuilding", "Building")
                        .WithMany("OfficeAssignments")
                        .HasForeignKey("OBLTId", "OfficeBuildingCode")
                        .OnDelete(DeleteBehavior.Restrict);
